            ...
            <div class="col-sm-8">
                <table width="100%">
                    ...
                    <tr>
                        <td>Alamat</td>
                        <td>:</td>
                        <td>Jl.kelayan.a Gg.12 Rt.21 No.56, Kelayan Dalam, Kec. Banjarmasin Selatan, Kota Banjarmasin, Kalimantan Selatan, dengan kode pos 70242.</td>
                        <td>Kelas</td>
                        <td>:</td>
                        <td><?= $kelas; ?></td>
                    </tr>
